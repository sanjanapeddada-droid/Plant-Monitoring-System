...
const char* password = ""; //the network password for the network.
const char* mqtt_server = ""; //the IP adress, this is different on different networks. Write ipconfig in powershell to find the adress. 
